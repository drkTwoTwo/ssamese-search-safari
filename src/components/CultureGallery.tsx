...
const CultureGallery = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 mb-16">
      <h2 className="text-2xl font-bold text-assamese-earth-dark text-center mb-8 bg-assamese-tea-light/90 py-2 rounded-lg shadow-md">Explore Assamese Culture</h2>
      
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {images.map((image, index) => (
          <motion.div
            key={index}
            className="relative overflow-hidden rounded-xl shadow-xl bg-assamese-earth-light/20"
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-assamese-earth-dark/90 p-4">
