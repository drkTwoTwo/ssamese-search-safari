...
const CultureGallery = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-4 mb-16">
      <h2 className="text-2xl font-bold text-assamese-earth-dark text-center mb-8 drop-shadow-md bg-assamese-tea-light/20 py-2 rounded-lg backdrop-blur-sm">Explore Assamese Culture</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {images.map((image, index) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-assamese-earth-dark/80 to-transparent p-4">
